...
const CONFIG = { 
    ...
    questions: {
        ...
        second: {
            ...
            nextBtn: "ENSERIO?!!!"                                         // Text for the next button
        },
        third: {
            text: "Quieres ser mi San Valentin este 14 de Feb Del 2026? 🌹", // The big question!
    ...
    music: {
        ...
        musicUrl: "https://res.cloudinary.com/dvodywkiv/video/upload/v1771043385/Keaton_Henson_-_Small_Hands_dvggzq.mp3", // Music streaming URL
